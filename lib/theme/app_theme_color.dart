...
class AppThemeColors extends ThemeExtension<AppThemeColors> {
  ...
  static const AppThemeColors classic = AppThemeColors(
    ...
    accent: AppColors.accentClassic,
    active: AppColors.activeClassic,
    selectedItem: AppColors.selectedItemClassic,
    scaffoldBg: AppColors.scaffoldBgClassic,
    appBarBg: AppColors.appBarBgClassic,
    drawerBg: AppColors.drawerBgClassic,
    drawerHeaderBg: AppColors.drawerHeaderBgClassic,
    navBarBg: AppColors.navBarBgClassic,
    cardBg: AppColors.cardBgClassic,
    surfaceBg: AppColors.surfaceBgClassic,
    primaryText: AppColors.primaryTextClassic,
    secondaryText: AppColors.secondaryTextClassic,
    arabicText: AppColors.arabicTextClassic,
    translationText: AppColors.translationTextClassic,
    appBarText: AppColors.appBarTextClassic,
    activeTabText: AppColors.activeTabTextClassic,
    inactiveTabText: AppColors.inactiveTabTextClassic,
    highlight: AppColors.highlightClassic,
    highlightBorder: AppColors.highlightBorderClassic,
    selectionOverlay: AppColors.selectionOverlayClassic,
    contextMenuBg: AppColors.contextMenuBgClassic,
    contextMenuText: AppColors.contextMenuTextClassic,
    dropdownBg: AppColors.dropdownBgClassic,
    divider: AppColors.dividerClassic,
    shadow: AppColors.shadowClassic,
    drawerScrim: AppColors.drawerScrimClassic,
  );
