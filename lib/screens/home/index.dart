  ...
  Widget build(BuildContext context) {
    return MyScaffold(
      ...
      body: GridView.count(
        ...
        mainAxisSpacing: 15,
        children: const [
          Resource(route: 'quran', title: 'Quran', icon: 'quran'),
          Resource(route: 'books', title: 'Books', icon: 'book'),
          ...
          Resource(route: 'namaz-time', title: 'Namaz Time', icon: 'namaz-time'),
          Resource(route: 'donation', title: 'Donation', icon: 'donate'),
          Resource(route: 'settings', title: 'Settings', icon: 'settings'),
        ],
      ),
    );
  }
