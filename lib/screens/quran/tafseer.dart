                        ...
                        return modelQuery.when(
                          ...
                          data: (resources) {
                            if (resources.isNotEmpty) {
                              var tafseer = resources.first;
                              String surah = contextualTranslation(
                                locale: currentLang,
                              ...
                              String qitab =
                                  '${locales.tafseer}: ${tafseer.tafseerQitab.value.title}';
